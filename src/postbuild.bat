...
copy icons\lh2mqtt\package_%2.ini %AppData%\TS3Client\plugins\installer\package.ini
...
del /Q lh2mqtt_1_%2%_0.ts3_plugin

echo.
echo Erstelle TS3-Plugin Installer
"C:\Program Files\7-Zip\7z.exe" a -tzip lh2mqtt_1_%2%_0.ts3_plugin "plugins/lh2mqtt_x64.dll" "plugins/lh2mqtt_x86.dll" "plugins/lh2mqtt/*.png" "plugins/lh2mqtt/*.crt" "package.ini"
